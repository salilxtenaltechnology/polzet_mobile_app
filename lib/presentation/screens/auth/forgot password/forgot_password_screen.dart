      ...
      if (response.statusCode == 200) {
       ...
       // _prefService.saveAccessToken(JWT_TOKEN);
        ...
        navigationPushReplacement(
            context, ChangePasswordScreen(email: _emailController.text,JWT_TOKEN: JWT_TOKEN));
      } else {
        setState(
    ...
    return CustomCard(
      widget: Column(
        ...
        children: [
          ...
          //         border:
          //             Border.all(color: AppColors.primaryColor, width: 0.7)),
          //     child: Center(
          //       child: _isSendingOtp
          //           ? Loader(color: AppColors.primaryColor)
          //           : Text('Get OTP',
