// ignore_for_file: deprecated_member_use, unused_local_variable, unused_element, unused_field
...
class _LoginScreenState extends State<LoginScreen> with UtilityMixin {
  ...
  void loginUser() async {
    ...
    if (_isLoginEmail) {
      ...
      bool isEmail =
          RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w]{2,4}$').hasMatch(emailOrUsername);
      bool isUsername =
          RegExp(r'^[a-zA-Z0-9_]{3,20}$').hasMatch(emailOrUsername);
    ...
    await apiService.loginUser(
        email_username: loginValue, password: password, context: context);
    if (!mounted) return;
    ...
    return CustomCard(
      widget: Column(
        ...
        children: [
          ...
          SizedBox(height: 12.h),
          AuthButton(
              title: 'Login', onPressed: loginUser, isLoading: _isLoading),
