...
import '../../../../api/model/request/incoming_request.dart';
...
class NotificationState extends State<Notifications>
  ...
  Future<void> acceptRequest(int requestId) async {
    ...
    try {
      ...
      final response =
          await _dio.put(ApiConstants.acceptRequest + '/$requestId',
              options: Options(
                headers: {
                  'Authorization': 'Bearer $accessToken',
                },
  ...
  String formatDateTime(String utcTime) {
    ...
    if (dayDifference == 0) {
      ...
      dayText =
          DateFormat('MMM dd, yyyy').format(date); // fallback for older dates
    }
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return incoming.isEmpty
                            ? Center(
                                child: Text(AppLocalizations.of(context)!.norequestavailable,
                                  ...
                                  return Column(
                                    children: [
                                      ListTile(
                                        ...
                                        leading: (userData.profile_picture !=
                                                    null &&
