...
import '../../screens/home/poll/new poll/add_poll_import.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(AppLocalizations.of(context)!.addnewpoll,
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.description_outlined,
                          size: 23.spMax, color: Colors.white),
                    ),
                  ),
                  SizedBox(height: 5.h),
                  Text(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(FeatherIcons.image,
                          size: 22.spMax, color: Colors.white),
                    ),
                  ),
                  SizedBox(height: 5.h),
                  Text(
