// ignore_for_file: deprecated_member_use, unused_local_variable, must_be_immutable, unused_element, avoid_function_literals_in_foreach_calls
...
class _HomeFeedPostCardState extends State<HomeFeedPostCard> {
  ...
  void _generateRandomImageIndices() {
    if (widget.post.images.isNotEmpty) {
      ...
      int maxImages = widget.post.images.length >= 3
          ? 3
          : widget.post.images.length;
  ...
  Widget build(BuildContext context) {
    ...
    if (!hasImages && !hasPolls) {
      return const SizedBox.shrink(); // Don't show posts with empty images and polls
    }
            ...
            child: Column(
              ...
              children: [
                ...
                if (hasImages && areAllImagesSelected)
                  GestureDetector(
                    onTap: () {
                      showToast(message: 'Poll submitted successfully!');
                    },
                    child: Center(
